...
#windows: SOURCES += $$PWD/service_win.cpp
#unix: SOURCES += $$PWD/service_unix.cpp


#    HEADERS += $$PWD/localpeer.h
#    SOURCES += $$PWD/localpeer.cpp
#    HEADERS += $$PWD/lockedfile.h
#    SOURCES += $$PWD/lockedfile.cpp
#windows: SOURCES += $$PWD/lockedfile_win.cpp
#unix: SOURCES += $$PWD/lockedfile_unix.cpp
#    HEADERS += $$PWD/uniquecoreapplication.h
#    SOURCES += $$PWD/uniquecoreapplication.cpp
